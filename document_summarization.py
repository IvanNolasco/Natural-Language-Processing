# -*- coding: utf-8 -*-
"""
Created on Thu Nov 22 11:05:21 2018
...
from prepare_reviews import prepare_articles, get_sent_in_text_of_word

def low_rank_svd(matrix, singular_count=2):
    u, s, vt = svds(matrix, k=singular_count)
    return u, s, vt

#lista de oraciones, oracion=cadena
...
"""
reviews = prepare_articles('C:\\Users\\navi_\\Desktop\\SFU_Spanish_Review_Corpus\\moviles\\')
texts = []
for r in reviews:
    texts.append(' '.join(r))
sentences = get_sent_in_text_of_word(texts, 'batería')
